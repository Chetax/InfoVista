...
import PermanentDrawerRight from '../RightSideBar/RightSideBar'; // Import the child component
...
function Home() {
    ...
    const fetchData = async () => {
        ...
        try {
            const options = {
                method: 'GET',
                url: 'https://api.newscatcherapi.com/v2/search', // Add your API endpoint here
    ...
    return (
        <Grid container>
            ...
            <Grid item xs={windowWidth > 1000 ? 8 : 10} sx={{ pl: 5, pr: 5, '@media(max-width:948px)': { pl: 2, pr: 2 } }}>
                <Box>
            ...
            <Grid item xs={12}>
                <PermanentDrawerRight onKeywordChange={(newKeyword) => dispatch(setKeyword(newKeyword))} />
            </Grid>
